...
define Device/xiaomi_mi-router-ax3000t-mod
  ...
  DEVICE_MODEL := Mi Router AX3000T
  DEVICE_VARIANT := (U-Boot mod)
  DEVICE_DTS := mt7981b-xiaomi-mi-router-ax3000t-mod
  DEVICE_DTS_DIR := ../dts
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += xiaomi_mi-router-ax3000t-mod

define Device/sl_3000
  DEVICE_VENDOR := SL
  DEVICE_MODEL := 3000 (NOR version)
...
define Device/sl_3000-emmc
  DEVICE_VENDOR := SL
  DEVICE_MODEL := 3000-emmc (eMMC version)
...
define Device/ruijie_rg-be72-pro
  ...
  DEVICE_PACKAGES += mt7988-2p5g-phy-firmware kmod-mt7992-23-firmware kmod-mt7992-firmware mt7988-wo-firmware kmod-usb3 automount swconfig kmod-rtl8372n_gsw
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
