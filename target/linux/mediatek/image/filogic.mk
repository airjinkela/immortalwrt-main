...
define Device/cudy_tr3000-v1-mod-512m
  DEVICE_VENDOR := Cudy
  DEVICE_MODEL := TR3000
  DEVICE_VARIANT := v1 (U-Boot mod 512M)
  DEVICE_DTS := mt7981b-cudy-tr3000-v1-mod-512m
  DEVICE_DTS_DIR := ../dts
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  ...
  DEVICE_PACKAGES :=  kmod-mt7915e kmod-usb3 kmod-mt7981-firmware mt7981-wo-firmware
endef
TARGET_DEVICES += cudy_tr3000-v1-mod-512m
